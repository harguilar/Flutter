...
class Reply{
  ...
  Reply({@required this.vendorId,@required this.vendorName, @required this.date,@required  this.brandNew, @required  this.price});
...
// factory Reply.fromJson(Map<dynamic, dynamic>json)=> _ReplyFromJson(json);
  ...
  static Reply replyFromJson(Map<dynamic,dynamic> json){
    return Reply(
        ...
        date: json['data'] == null ? null : (json['data'] as DateTime),
  ...
  Reply.fromDocument(DocumentSnapshot snapshot){
    ...
    date = snapshot.data['data'].toDate();
